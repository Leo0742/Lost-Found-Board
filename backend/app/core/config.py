...
class Settings(BaseSettings):
    ...
    create_rate_limit_max_items_anon: int = 3
    upload_rate_limit_window_minutes: int = 10
    upload_rate_limit_max: int = 12
    upload_rate_limit_max_anon: int = 5
    link_code_rate_limit_window_minutes: int = 30
    link_code_rate_limit_max: int = 6
    link_confirm_rate_limit_window_minutes: int = 20
    link_confirm_rate_limit_max: int = 10
    flag_rate_limit_window_minutes: int = 30
    flag_rate_limit_max: int = 8
    flag_rate_limit_max_anon: int = 5
    claim_rate_limit_window_minutes: int = 30
    claim_rate_limit_max: int = 8
    claim_rate_limit_max_anon: int = 2
    smart_search_rate_limit_window_minutes: int = 10
    smart_search_rate_limit_max: int = 60
    category_suggest_rate_limit_window_minutes: int = 10
    category_suggest_rate_limit_max: int = 60
