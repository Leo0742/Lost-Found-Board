...
class UserProfile(Base):
    ...
    profile_addresses_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    address_visibility: Mapped[str] = mapped_column(String(16), nullable=False, default="all", server_default="all")
    address_visibility_address_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
